...
from functions.trades import all_trades, create_trade_e, update_trade_e, delete_trade_e, request_materials_s, \
    create_trade_material_s, update_trade_material_s
from models.trades import Trades
from utils.login import get_current_active_user
from utils.db_operations import the_one
from schemas.trades import CreateTrade, UpdateTrade, RequestMaterial, CreateMaterial, UpdateMaterial
...
def get_trades(search: str = None, id: int = 0, page: int = 0,
               limit: int = 25, order_id: int = None, stage_id: int = None,
    ...
    return all_trades(search, page, limit, order_id, stage_id, db, current_user)
