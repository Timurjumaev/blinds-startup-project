...
def get_warehouse_materials(search: str = None, id: int = 0, page: int = 0, limit: int = 25, db: Session = Depends(database),
    ...
    return all_warehouse_materials(search, page, limit, db)
