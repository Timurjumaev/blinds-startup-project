...
def get_standart_mechanisms(search: str = None, id: int = 0, page: int = 0, limit: int = 25, db: Session = Depends(database),
    ...
    return all_standart_mechanisms(search, page, limit, db)
